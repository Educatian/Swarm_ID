...
![1단계 — 로그인](./screenshots/student-ko/01-login.png)

**https://swarmid.vercel.app**에 접속해 교수자가 제공한 계정으로
...
![2단계 — 온보딩](./screenshots/student-ko/02-onboarding.png)
...
![3단계 — 케이스 선택](./screenshots/student-ko/03-pick-case.png)

**시작 패널**을 스크롤해 **강의 케이스** 목록을 찾으세요.
**게시됨** 태그가 붙은 카드만 학생에게 열려 있습니다. 교수자가
지정한 카드의 **케이스 열기**를 누르세요.

**팁.** 목록이 비어 있다면 교수자가 아직 게시를 안 한 상태입니다 —
교수자에게 알려 주세요.
...
![4단계 — 케이스 맵](./screenshots/student-ko/04-case-map.png)

캔버스가 케이스를 네트워크로 표시합니다:

- 케이스 제목을 담은 중앙 **코어** 노드
- 코어를 둘러싼 5명의 이해관계자 노드(교사·학생·에듀테크·행정·접근성)
...
![5단계 — 첫 질문](./screenshots/student-ko/05-first-question.png)
...
![6단계 — 스웜 라운드](./screenshots/student-ko/06-swarm-round.png)
...
![7단계 — 이견 엣지](./screenshots/student-ko/07-disagreement-edges.png)
...
![8단계 — 도전 버튼](./screenshots/student-ko/08-challenge-button.png)
...
![9단계 — 맵에 추가](./screenshots/student-ko/09-add-agenda.png)
...
![10단계 — 리포트](./screenshots/student-ko/10-report.png)
...
![11단계 — 내보내기](./screenshots/student-ko/11-export.png)
...
| 증상 | 원인 추정 | 조치 |
|---|---|---|
| "질문하기"를 눌렀는데 반응이 없음 | 오프라인 또는 Gemini 쿼터 소진 | 와이파이 확인 후 교수자에게 보고 |
...
| 강의 케이스가 안 보임 | 초안 상태 | 교수자가 게시해야 함 |
...
5. **마지막에 내보내세요.** 교수자가 활동 내역을 볼 수 있지만,
