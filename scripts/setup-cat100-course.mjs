...
const COURSE_NAME = "CAT 100";
const COURSE_CODE = "CAT100";
const JOIN_CODE = "UA-CAT100-SUMMER26"; // must match JOIN_CODE in cat100.html

const INSTRUCTOR = {
  email: "jmoon19@ua.edu",
  password: "cat531-instructor", // SHARED instructor account (same as CAT531); leave as-is so reruns don't reset it
  name: "Jewoong Moon",
  title: "Instructor",
};
...
(async () => {
  console.log(`Setting up CAT 100 course on ${SUPABASE_URL}`);
  ...
  console.log("  3. Share the student link:  <your-deploy>/cat100.html");
  console.log("Done.");
})();
