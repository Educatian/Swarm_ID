...
const COURSE_NAME = "CAT 100"; // edit if you want a fuller title
const COURSE_CODE = "CAT100";
const JOIN_CODE = "UA-CAT100-SUMMER26";
const COHORT = "ua-cat100";

const INSTRUCTOR = {
  email: "jmoon19@ua.edu",
  password: "cat531-instructor", // SHARED instructor account (same as CAT531); leave as-is
  name: "Jewoong Moon",
  title: "Instructor",
  role: "admin",
};

// TODO: paste the real CAT 100 roster here. Keep IDENTICAL to ROSTER in
// cat100.html and STUDENT_NAMES in enroll-cat100-class.mjs.
const STUDENT_NAMES = [
  // "First Last",
];
...
// CAT100 accounts are namespaced (@cat100.swarm.io) so they never collide with
// CAT531 accounts even if the same person is in both courses.
...
(async () => {
  console.log(`Seeding CAT 100 course on ${SUPABASE_URL}`);
  ...
  console.log("\nNext step: run  `node scripts/enroll-cat100-class.mjs`  to enroll the students.");
  console.log("Done.");
})();
